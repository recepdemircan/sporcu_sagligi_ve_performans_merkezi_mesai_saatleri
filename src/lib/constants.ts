...
export const USERS: User[] = [
  ...
  { id: '5', name: 'Berke Ünay', role: 'senior', title: 'Fizyoterapist' },
  { id: '6', name: 'Mertcan Kara', role: 'senior', title: 'Fizyoterapist' },
  { id: '7', name: 'Duhan Batıkan', role: 'fixed', title: 'Fizyoterapist (Akşam Ekibi)' },
  { id: '8', name: 'Minel', role: 'fixed', title: 'Fizyoterapist (Akşam Ekibi)' },
